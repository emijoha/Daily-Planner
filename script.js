...
$(document).ready(function () {
    ...
    // This function determines background color of each timeblock as time goes by
    var colorCode = function () {
        // Check hour stamp of each timeblock to assign color code
        currentDate = moment();
        currentHour = parseInt(currentDate.format("HH"));
        ...
        for (var i = 0; i < 9; i++) {
            ...
            if (textTime === currentHour) {
                ...
                buttonImages[i].removeProp("disabled");
            }
                ...
                buttonImages[i].prop("disabled", true);
            }
            else {
    ...
    // Collecting functions that require interval into one function, this will be set on interval
